...
const DECK = [
  ...
  // ── Neutraal (vangnet) ──────────────────────────────────────────────────────
  { id: 'gewone_dag', gewicht: 1, conditie: () => true,
    tekst: 'Een gewone dag in het leven van een atleet in opbouw. Kleine keuzes, groot verschil op termijn.',
    hint: null },
  { id: 'honger', gewicht: 1, conditie: () => true,
    tekst: 'Je buddy heeft honger als een paard. Groeien en trainen kosten nu eenmaal energie.',
    hint: 'Denk aan de voedingsdriehoek: gevarieerd en genoeg.' },
];
