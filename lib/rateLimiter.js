...
const ADMIN_ACTIONS = new Set([
    ...
    'update_teacher_klassen',
    // archive.js (daar ook hardcoded 'admin')
    'archiveer_rankings', 'deactiveer_ontbrekende', 'verwijder_verlopen', 'heractiveer',
    // tests.js — school-beheer
    'save_school', 'delete_school', 'import_normen',
]);
