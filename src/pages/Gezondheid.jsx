          ...
          <div 
            ...
            style={{
              background: `conic-gradient(from -45deg, 
                #60a5fa 0deg, #3b82f6 ${welzijnScores.beweging * 0.9}deg, #e5e7eb ${welzijnScores.beweging * 0.9}deg 90deg,
                #4ade80 90deg, #22c55e ${90 + welzijnScores.voeding * 0.9}deg, #e5e7eb ${90 + welzijnScores.voeding * 0.9}deg 180deg,
                #a78bfa 180deg, #8b5cf6 ${180 + welzijnScores.slaap * 0.9}deg, #e5e7eb ${180 + welzijnScores.slaap * 0.9}deg 270deg,
                #fb923c 270deg, #f97316 ${270 + welzijnScores.mentaal * 0.9}deg, #e5e7eb ${270 + welzijnScores.mentaal * 0.9}deg 360deg)`,
              mask: 'radial-gradient(transparent 120px, black 120px)', WebkitMask: 'radial-gradient(transparent 120px, black 120px)',
